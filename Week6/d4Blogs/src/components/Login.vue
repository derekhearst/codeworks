<template>
  <span class="">
    <button
      class="btn selectable text-success lighten-30 text-uppercase my-lg-0 my-2"
      @click="login"
    ...
    <div v-else>
      <div class="dropdown dropstart my-lg-0 my-2">
        <div
          type="button"
          class="bg-dark selectable no-select border-0"
