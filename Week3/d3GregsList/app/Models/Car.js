...
export class Car {
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="d-flex justify-content-between">
            ...
            <button onclick="app.carsController.remove('${this.id}')" title="Delete car!" class="btn btn-danger">
  ...
  static GetCarFormTemplate() {
    return /*html*/`
    <form class="d-flex gap-4 flex-wrap shadow rounded p-3 bg-white m-2 justify-items-center justify-content-start" onsubmit="app.carsController.create()">
      ...
      <div class="form-floating">
        <input class="form-control" placeholder="Leave a description here" id="car-description"
